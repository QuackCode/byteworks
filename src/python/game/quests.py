...
QUESTS = [
    ...
    Quest("variables", "Write a program that stops by itself once you have 100 RAM (use num_items)",
          lambda s, w: s.finished and "num_items" in s.calls and s.total() > 0 and w.inventory["RAM"] >= 100,
          needs_finish=True),
